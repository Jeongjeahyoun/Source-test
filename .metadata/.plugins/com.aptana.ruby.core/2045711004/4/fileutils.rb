module FileUtils
  ...
  LOW_METHODS = [:private_module_function, :cd, :uptodate?, :commands, :have_option?, :options_of, :collect_method, :identical?, :remove_file, :copy_file, :copy_entry, :remove_entry_secure, :remove_entry, :copy_stream, :options, :remove_dir, :compare_file, :compare_stream, :cmp, :chdir, :getwd, :pwd]
  LowMethods = FileUtils::LowMethods
  METHODS = [:mkdir_p, :cd, :uptodate?, :mkpath, :makedirs, :ln, :identical?, :install, :remove_file, :ln_s, :ln_sf, :cp, :remove, :chmod, :chown, :copy_file, :copy, :link, :symlink, :cp_r, :copy_entry, :mv, :remove_entry_secure, :remove_entry, :move, :rm, :rm_f, :safe_unlink, :rm_r, :rm_rf, :copy_stream, :rmtree, :remove_dir, :compare_file, :compare_stream, :cmp, :chmod_R, :chown_R, :touch, :chdir, :getwd, :pwd, :mkdir, :rmdir]
